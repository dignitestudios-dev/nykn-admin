...
const UserSkeleton = () => {
  ...
  return (
    <div className="w-full grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
      {arr?.map((ar) => {
        return (
          <div
            key={ar}
            className="animate-pulse w-full   h-auto p-2 md:p-4 flex flex-col gap-6 justify-between items-start rounded-2xl "
            style={{
