...
const UserWishlistCard = ({ attraction }) => {
  const { palette } = useContext(GlobalContext);
  return (
    <div className="w-full bg-white shadow border border-[#eaeaea] rounded-xl md:rounded-full h-auto flex flex-col justify-start items-start gap-2">
      <div
